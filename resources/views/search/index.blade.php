...
<div class="text-center mt-6 mb-4">
    <button @click="tour.start()"
            class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-6 py-3 rounded-full shadow-lg transition-colors cursor-pointer">
        ...
        Take the Tour <span class="text-indigo-200 font-normal text-sm">(8 features, ~3 min)</span>
    </button>
</div>
